...
export default function SoilMoistureCard({ 
  ...
  soilMoisture: number | "apagado" | "no conectado"
  ...
  sensorStatus: "encendido" | "apagado"
    ...
    const isConnected = typeof soilMoisture === 'number' && sensorStatus === "encendido"
    let content: React.ReactNode

    if (soilMoisture === "apagado" || soilMoisture === "no conectado" || sensorStatus === "apagado") {
        content = (
            <div className="space-y-2">
                <div className="text-2xl font-bold text-red-500">
                    {sensorStatus === "apagado" ? "apagado" : soilMoisture}
                </div>
